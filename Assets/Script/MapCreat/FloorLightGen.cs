...
{
    public class FloorLightGen : MonoBehaviour
    {
        ...
        void Update()
        {
            for(int i = lights.Count - 1; i >= 0 ; i--)
            {
                ...
                else
                {
                    ...
                    else if (lights[i][4] == 1)
                    {
                        lightGameObjects[i].transform.rotation = Quaternion.Euler(new Vector3(0, 0, 0));
                    }
                    else if(lights[i][4] == 2)
                    {
                        lightGameObjects[i].transform.rotation = Quaternion.Euler(new Vector3(0, 0, 270));
                    }
                    else if (lights[i][4] == 3)
                    {
                        lightGameObjects[i].transform.rotation = Quaternion.Euler(new Vector3(0, 0, 180));
                    }
                }
            }
        }

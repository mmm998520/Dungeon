    ...
    public class PlayerManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            else
            {
                ...
                {
                    HP = MaxHP;
                    GamePad.SetVibration((PlayerIndex)1, 0.1f, 0.1f);
                    GamePad.SetVibration((PlayerIndex)2, 0.1f, 0.1f);
                    GamePad.SetVibration((PlayerIndex)3, 0.1f, 0.1f);
                    GamePad.SetVibration((PlayerIndex)4, 0.1f, 0.1f);
                }
                else
                {
